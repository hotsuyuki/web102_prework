...
function addGamesToPage(games) {
    ...
    for (const game of games) {
        ...
        gameCard.innerHTML = `
            ...
            <p>Backers: ${game.backers.toLocaleString("en-US")} people</p>
        `
...
const numContributions = GAMES_JSON.reduce( (sum, game) => {
    return sum + game.backers;
}, 0);

// set the inner HTML using a template literal and toLocaleString to get a number with commas
contributionsCard.innerHTML = `
    <p>${numContributions.toLocaleString("en-US")} people</p>
`
...
gamesCard.innerHTML = `
    <p>${numGames.toLocaleString("en-US")} games</p>
`
...
const descriptionString = `
    A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${numGames.toLocaleString("en-US")} ${numGames == 1 ? "game" : "games"}.
    Currently, ${numUnfundedGames.toLocaleString("en-US")} ${numUnfundedGames == 1 ? "game remains" : "games remain"} unfunded.
